...
if (!function_exists('masygal_gallery_init')) :
...
endif; // end masygal_gallery_init
add_action('init', 'masygal_gallery_init');

if (!function_exists('masygal_add_custom_columns')) :
...
endif; // end masygal_add_custom_columns

add_filter('manage_masy-gallery_posts_columns', 'masygal_add_custom_columns');

if (!function_exists('masygal_custom_gallery_column')) :
	function masygal_custom_gallery_column($column, $post_id)
	{
?>
		<style type="text/css">
			span.shortcode {
...
endif; // end masygal_custom_gallery_column
add_action('manage_masy-gallery_posts_custom_column', 'masygal_custom_gallery_column', 10, 2);
