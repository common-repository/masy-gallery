...
endif; // end masygal_meta_box_ctr


if (!function_exists('masygal_meta_box_save')) :
...
endif; // end masygal_meta_box_save
add_action('save_post', 'masygal_meta_box_save', 10, 2);

if (!function_exists('masygal_get_image_ids')) :
...
endif; // end masygal_get_image_ids
?>