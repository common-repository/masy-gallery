...
if (!function_exists('masygal_justified_shortcode_handler')) :
...
?>
		...
		<div id="masygal-justified-gallery-<?= $atts['id'] ?>">
			...
			?>
					<a class="item" <?php if ($fancybox == 'true') { ?> <?php if ($fancybox_title == 'true') { ?> data-caption="<b><?= get_the_title($image) ?></b>" <?php } ?> data-fancybox="gallery" href="<?= esc_url(wp_get_attachment_url($image)); ?>" <?php } ?>>
...
endif; // end masygal_justified_shortcode_handler
